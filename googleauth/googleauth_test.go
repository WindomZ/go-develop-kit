...
func TestHotpCode(t *testing.T) {
	...
	var counterCodes = []struct {
		...
		{ /* 1 */
			293240, true, 2}, // increments on success
		{ /* 1 */
			293240, false, 3}, // and failure
		{ /* 5 */
			932068, true, 6}, // inside of window
		{ /* 10 */
			481725, false, 7}, // outside of window
		{ /* 10 */
			481725, false, 8}, // outside of window
		{ /* 10 */
			481725, true, 11}, // now inside of window
	}
...
func TestAuthenticate(t *testing.T) {
	...
	var attempts = []attempt{
		...
		{ /* 1 */
			"293240", true}, // hopt increments on success
		{ /* 1 */
			"293240", false}, // hopt failure
